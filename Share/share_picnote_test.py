...
class MyTestCase(unittest.TestCase):
    ...
    def test_share_picnote(self):
        print "************ share picture note method ***********"
        ...
        time.sleep(2)
        #判断当前页上有此文档
        common.exists(share_constant.pic_title)
        #open picture
        self.driver.find_element_by_name(share_constant.pic_title).click()
        #click share button
