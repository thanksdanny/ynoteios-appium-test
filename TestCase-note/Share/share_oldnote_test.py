...
class MyTestCase(unittest.TestCase):
    ...
    def test_share_oldnote(self):
        print "************  share old note method ***********"
        ...
        time.sleep(2)
        #判断当前页上有此文档
        common.exists(share_constant.oldnote_title)
        #open note
        self.driver.find_element_by_name(share_constant.oldnote_title).click()
