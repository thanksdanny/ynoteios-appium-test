...
class MyTestCase(unittest.TestCase):
    ...
    def test_share_wordnote(self):
        print "************ share word note method ***********"
        ...
        time.sleep(2)
        common.exists(share_constant.word_title)
        #open word
        self.driver.find_element_by_name(share_constant.word_title).click()
        #click share button
