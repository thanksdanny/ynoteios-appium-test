...
class MyTestCase(unittest.TestCase):
    ...
    def test_share_othernote(self):
        print "************  share other note method ***********"
        ...
        time.sleep(2)
        #判断当前页上有此文档
        common.exists(share_constant.other_title)
        #open other word
        self.driver.find_element_by_name(share_constant.other_title).click()
        #click share button
        ...
        time.sleep(5)
        #检验 分享成功提示出现
        self.assertTrue(self.driver.find_elements_by_name('链接复制成功')[0].is_displayed(),'分享旧笔记失败！')
