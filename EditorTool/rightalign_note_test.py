...
class MyTestCase(unittest.TestCase):
    ...
    def test_rightalign_note(self):
        print "************ rightalign note method ***********"
        ...
        #点 右对齐 按扭
        self.driver.find_element_by_name('rightalign').click()
        #点编辑区，进入编辑模式
        self.driver.find_element_by_class_name('TextView').click()

        #输入5行内容
        for i in range(1,6):
            self.driver.find_element_by_class_name('TextView').send_keys(editorconstant.rightalign[1])
