...
class MyTestCase(unittest.TestCase):
    ...
    def test_shareright_note_comment(self):
        ...
        time.sleep(2)
        #open
        self.driver.find_element_by_name(shareright_constant.note_comment_title).click()
        time.sleep(2)
        #click share button
        ...
        #check 评论权限设置成功
        self.assertTrue(self.driver.find_element_by_name('禁止编辑，允许评论').is_displayed(),'笔记设置分享可评论失败！')
