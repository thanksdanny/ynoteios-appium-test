...
class MyTestCase(unittest.TestCase):
    ...
    def test_share_exclnote(self):
        print "************  share excl note method ***********"
        ...
        time.sleep(2)
        #判断当前页上有此文档
        common.exists(share_constant.excl_title)
        #open excl
        self.driver.find_element_by_name(share_constant.excl_title).click()
        #click share button
