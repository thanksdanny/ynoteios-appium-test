...
class MyTestCase(unittest.TestCase):
    ...
    def test_share_pdfnote(self):
        print "************  share pdf note method ***********"
        ...
        time.sleep(2)
        #判断当前页上有此文档
        common.exists(share_constant.pdf_title)
        #open note
        self.driver.find_element_by_name(share_constant.pdf_title).click()
        #click share button
