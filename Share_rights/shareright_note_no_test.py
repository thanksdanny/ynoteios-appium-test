...
class MyTestCase(unittest.TestCase):
    ...
    def test_shareright_note_no(self):
        print "************  share right no method ***********"
        ...
        time.sleep(2)
        #open
        self.driver.find_element_by_name(shareright_constant.note_noright_title).click()
        time.sleep(3)
        #click share button
        ...
        #check 评论权限设置成功
        self.assertTrue(self.driver.find_element_by_name('禁止编辑，禁止评论').is_displayed(),'笔记设置分享禁止评论和编辑失败！')
