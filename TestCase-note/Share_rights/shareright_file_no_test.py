...
class MyTestCase(unittest.TestCase):
    ...
    def test_shareright_file_no(self):
        print "************  share right file no method ***********"
        ...
        time.sleep(2)
        #open
        self.driver.find_element_by_name(shareright_constant.file_noright_title).click()
        time.sleep(3)
        #click share button
        ...
        #check 评论权限设置成功
        self.assertTrue(self.driver.find_element_by_name('禁止评论').is_displayed(),'文件设置分享禁止评论失败！')
